...
export function Experience() {
  ...
  const experiences = [
    ...
    },
    {
      ...
      location: t("location"),
      period: t("cout_companyYear"),
      color: "from-purple-500 to-pink-500",
      current: false,
    },
    {
      company: t("ATS_company"),
      position: t("frontend_developer"),
      location: t("location"),
      period: t("cout_ATSYear"),
            ...
            >
              <CardContent className="pt-8 pb-6">
                <div className="flex flex-col md:flex-row gap-6">
                  <div
                    className={`shrink-0 inline-flex p-4 bg-gradient-to-br ${exp.color} rounded-2xl shadow-lg group-hover:scale-110 transition-transform duration-300 h-fit`}
                  >
                  ...
                  <div className="flex-1">
                    <div className="flex flex-wrap items-start justify-between gap-2 mb-3">
                      <div>
                        <h3 className="text-slate-900 dark:text-white transition-colors text-xl mb-1">
                          {exp.company}
                        </h3>
