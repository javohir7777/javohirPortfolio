...
export function About() {
  ...
  return (
    <section id="about" className="py-24 px-4 bg-white dark:bg-slate-900 transition-colors relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-slate-900 dark:text-white mb-6 transition-colors">{t("about_title")}</h2>
          ...
          {features.map((feature, index) => (
            ...
            >
              <CardContent className="pt-8 pb-6">
                <div className={`mb-6 inline-flex p-4 bg-gradient-to-br ${feature.color} rounded-2xl shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                  <feature.icon className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-slate-900 dark:text-white mb-3 transition-colors text-xl">{feature.title}</h3>
                <p className="text-slate-600 dark:text-slate-300 transition-colors leading-relaxed">{feature.description}</p>
              </CardContent>
            </Card>
          ))}
        </div>
