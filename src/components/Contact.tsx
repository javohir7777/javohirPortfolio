...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-24 px-4 bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/30 dark:from-slate-800 dark:via-slate-800 dark:to-slate-900 transition-colors relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-slate-900 dark:text-white mb-6 transition-colors">{t("contact_title")}</h2>
          ...
          <CardContent className="pt-8 pb-8">
            <div className="grid md:grid-cols-3 gap-6">
              {contactInfo.map((contact, index) => (
                ...
                >
                  <div className={`p-4 bg-gradient-to-br ${contact.color} rounded-2xl shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                    <contact.icon className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <p className="text-slate-500 dark:text-slate-400 transition-colors text-sm mb-1">{contact.label}</p>
                    <p className="text-slate-900 dark:text-white transition-colors font-medium">{contact.value}</p>
                  </div>
                </a>
              ))}
            </div>
        ...
        <div className="text-center">
          <p className="text-slate-600 dark:text-slate-300 mb-6 text-lg transition-colors">{t("social_media")}</p>
