...
export function Skills() {
  ...
  const skillCategories = [
    {
      category: t("frontend"),
      skills: ["React", "TypeScript", "JavaScript", "Next.js", "Redux", "Redux Toolkit", "HTML", "CSS", "Scss"],
      icon: "🎨"
    },
    {
      category: t("backend"),
      skills: ["Node.js", "Express", "REST API", "Axios"],
      icon: "⚙️"
    },
    {
      category: t("tools"),
      skills: ["Git", "GitHub", "Material UI", "Ant Design", "Bootstrap", "Figma", "VS Code"],
      icon: "🛠️"
    }
  ];

  return (
    <section id="skills" className="py-24 px-4 bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/30 dark:from-slate-800 dark:via-slate-800 dark:to-slate-900 transition-colors relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-slate-900 dark:text-white mb-6 transition-colors">{t("skills_title")}</h2>
          ...
          {skillCategories.map((category, index) => (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-slate-900 dark:text-white transition-colors text-xl">{category.category}</h3>
              </div>
        ...
        <div className="mt-16 bg-white dark:bg-slate-800/50 rounded-2xl p-8 shadow-xl backdrop-blur-sm border border-slate-200 dark:border-slate-700">
          <div className="text-center mb-6">
            <h3 className="text-slate-900 dark:text-white text-2xl mb-2">🌍 {t("languages")}</h3>
          </div>
