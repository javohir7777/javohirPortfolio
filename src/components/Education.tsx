...
export function Education() {
  ...
  return (
    <section
      id="education"
      className="py-24 px-4 bg-gradient-to-br from-slate-50 via-purple-50/30 to-pink-50/30 dark:from-slate-800 dark:via-slate-800 dark:to-slate-900 transition-colors relative overflow-hidden"
    >
          ...
          {education.map((edu, index) => (
            ...
            >
              <CardContent className="pt-8 pb-6">
                <div
                  className={`mb-6 inline-flex p-4 bg-gradient-to-br ${edu.color} rounded-2xl shadow-lg group-hover:scale-110 transition-transform duration-300`}
                >
